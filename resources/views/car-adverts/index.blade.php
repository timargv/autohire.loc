                                ...
                                <a href="{{ route('cars.adverts.show', $carAdvert) }}" class="row text-decoration-none">
                                    ...
                                    <div class="card-body p-0 pt-2">
                                        <div class="d-flex pt-1">
                                            <div class="card-title font-weight-bold text-dark">{{ $carAdvert->carBrand->name }} {{  $carAdvert->carModel ? $carAdvert->carModel->name : '' }}, {{ $carAdvert->carYear->name }}</div>
                                            <div class="ml-auto font-weight-bold">
                                                <span id="priceCarAdvert">{{ $carAdvert->price_per_day }}</span>
                                                <span class="font-weight-light text-muted small" data-toggle="tooltip" data-placement="top" title="Тип Аренды">/ {{ $carAdvert->getTypeRental() }}</span>
                                            </div>
                                        </div>
                                        <div class="">
