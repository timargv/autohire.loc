...
@section('content')
    <div class="row my-5 mr-0">
        <div class="col-md-3 col-12 pr-0 pr-md-3 mb-3">
            @include('car-adverts._filter')
        </div>
        <div class="col-md-9 col-12 pr-0  mb-3">
                ...
                <div class="brand-readme row clearfix overflow-hidden mx-0">
                    @if (!empty($carModelsOrSeries))
                        @foreach (array_chunk($carModelsOrSeries, 3) as $chunk)
                            <ul class="list-group list-unstyled col-md-3 mb-md-3">
