@forelse ($carAdverts as $carAdvert)
    <div class="@if(!empty($col_1)) col-12 @else col-12 col-lg-6 @endif mb-md-3 mb-2">
        <div class="car_sh card border-left-0 bottom-right-0 border-top-0 border-bottom shadow-sm overflow-hidden rounded-0">
            <a href="{{ route('cars.adverts.show', $carAdvert) }}" class="car_sh_href position-absolute w-100 h-100"></a>
                    ...
                    <div class="py-3 pl-3 pr-2 p-md-3 h-100">
                        <div class="car_sh_info pr-3 py-0 h-100">
                            ...
                            <div class="car_sh_price mb-3">
                                ...
                                <div class="price">{{ number_format($carAdvert->price_per_day, 0, '.', ' ') }}<i class="fal fa-ruble-sign ml-1"></i></div>
                            </div>
