@foreach ($messages->orderBy('id')->with('user')->get() as $message)
    <div class="card mb-3  @if($message->user->isAdmin() || $message->user->isModerator()) border-info @else border-0  @endif w-md-75 @if($message->isMessageOwn() ) ml-md-auto @else mr-md-auto @endif">
