<p>
    ...
    <a href="{{ route('admin.users.avatar.home') }}" class="btn btn-{{ $page === 'avatars' ? 'primary' : 'outline-primary' }} btn-sm mb-2 mb-md-0"><i class="fal fa-images mr-1"></i>Аватарки @if($countModerationAvatars)<span class="badge badge-primary">{{ $countModerationAvatars }}</span>@endif</a>
