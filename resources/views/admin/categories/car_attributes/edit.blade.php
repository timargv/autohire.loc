        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="required" name="required" {{ old('required', $attribute->required) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="status" name="status" {{ old('status', $attribute->status != 'off') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="is_visible" name="is_visible" {{ old('is_visible', $attribute->is_visible != 'off') ? 'checked' : '' }}>
