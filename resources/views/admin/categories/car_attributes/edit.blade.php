...
@section('content')
    <div class="box box-solid">
        ...
        <div class="box-body ">
        <form method="POST" action="{{ route('admin.categories.car.attributes.update', $attribute) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <textarea id="variants" type="text" class="form-control{{ $errors->has('sort') ? ' is-invalid' : '' }}" name="variants"  rows="5">{{ old('variants', implode("\n", $attribute->variants)) }}</textarea>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input flat-red" id="required" name="required" {{ old('required', $attribute->required) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input flat-red" id="status" name="status" {{ old('status', $attribute->status != 'off') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input flat-red" id="is_visible" name="is_visible" {{ old('is_visible', $attribute->is_visible != 'off') ? 'checked' : '' }}>
