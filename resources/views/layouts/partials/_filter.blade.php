                ...
                <div class="filter-form">
                    <form action="{{ $route }}" method="GET" class="input-group input-group-sm ">
                        ...
                        <div class="row ml-0 w-100">
                            <div class="form-group pr-md-3 filter-7">
                                <select id="car_year" class="form-control  {{ $errors->has('car_year') ? ' is-invalid' : '' }} my-select" data-container="body" data-size="5" name="car_year" data-placeholder="{{ trans_choice('fillable.CarYears', 1) }}">
                            ...
                            <div class="form-group pr-md-3 filter-7">
                                <select id="type_rental" class="form-control {{ $errors->has('type_rental') ? ' is-invalid' : '' }} my-select" data-container="body" data-size="5" name="type_rental" data-placeholder="{{ trans_choice('fillable.TypeRental', 1) }}">
                            ...
                            @foreach ($attributes as $attribute)
                                <div class="form-group pr-md-3 filter-7">
                                    @if ($attribute->isSelect())
                                        <select id="attribute_{{ $attribute->id }}" class="form-control  {{ $errors->has('attributes.' . $attribute->id) ? ' is-invalid' : '' }} my-select" data-container="body" data-size="5" data-width="100%" name="attrs[{{ $attribute->id }}][equals]" data-placeholder="{{ $attribute->name }}">
