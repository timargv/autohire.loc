<ul class="navbar-nav ml-auto">
    ...
    @else
        ...
        @endcan
        <li class="nav-item">
            <a class="nav-link font-weight-light px-2 py-1 mt-1 rounded bg-siran  text-white" href="{{ route('cabinet.adverts.create') }}"><i style="font-size: 18px; position:relative; top: 2px" class="fal fa-plus mr-2 ml-1"></i>{{ __('menu.AddAdvert') }}</a>
        </li>
