...
return [
    ...
    */
    ...
    'image' => 'Файл :attribute должно быть изображение.',
    ...
    'max' => [
        ...
        'string' => 'В :attribute не может быть больше чем :max символов.',
        'array' => 'В :attribute не может быть больше чем :max элемента.',
    ],
    'mimes' => ' :attribute должен быть файлом тип: :values.',
    'mimetypes' => ' :attribute должен быть файл типа: :values.',
    'min' => [
        'numeric' => 'В :attribute должно быть не менее :min.',
        'file' => 'В :attribute должно быть не менее :min kilobytes.',
        'string' => 'В :attribute должно быть не менее :min символов.',
        'array' => 'В :attribute должно быть не менее :min элемента.',
    ],
    ...
    'size' => [
        ...
        'string' => 'The :attribute должно быть :size characters.',
        'array' => 'The :attribute должен содержать :size количество.',
    ],
    'starts_with' => 'The :attribute должен начинаться с одного из следующих: :values',
    'string' => 'В :attribute не должно быть пустой строкой.',
    'timezone' => 'The :attribute должна быть действительной зоной.',
    'unique' => ' :attribute уже занято.',
    'uploaded' => ' :attribute не удалось загрузить.',
    'url' => 'The :attribute неверный формат.',
