...
class CarBrandsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::transaction(function () {
            ...
            $carBrand->children()->create(['name' => '02 (E10)', 'name_ru' => '02 (E10)', 'status' => 'active', 'author_id' => 1, 'slug' => Str::slug('02 (E10)')])->children()->createMany([['name' => 'I', 'name_ru' => 'I', 'status' => 'active', 'author_id' => 1, 'slug' => Str::slug('I')]])
            ;
